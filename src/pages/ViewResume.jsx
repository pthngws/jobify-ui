        ...
        <div className="max-w-4xl mx-auto">
          ...
          <a
            ...
            <div className="flex gap-3">
              ...
              <button
                onClick={() => navigate("/profile")}
                className="inline-flex items-center px-5 py-2.5 bg-gray-200 dark:bg-gray-600 text-gray-700 dark:text-gray-200 rounded-md hover:bg-gray-300 dark:hover:bg-gray-500 hover:shadow-sm transition-all duration-200"
              >
                <svg
                  className="w-5 h-5 mr-2"
                  fill="none"
