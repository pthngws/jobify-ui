        ...
        <div className="flex-1 flex flex-col sm:flex-row items-center gap-4">
          ...
          <div className="flex flex-col sm:flex-row gap-3 w-full sm:w-auto">
            <select
              ...
              onChange={handleFilterChange}
              className="w-full sm:w-45 px-4 py-2 bg-gray-50 dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent outline-none text-gray-900 dark:text-gray-100 transition-colors duration-200"
            >
